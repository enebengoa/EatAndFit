 ...
 */
class Lista extends \App\AdminBundle\Entity\Lista implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\AdminBundle\\Entity\\Lista' . "\0" . 'id', '' . "\0" . 'App\\AdminBundle\\Entity\\Lista' . "\0" . 'fechaCreacion', '' . "\0" . 'App\\AdminBundle\\Entity\\Lista' . "\0" . 'ordenescompras', '' . "\0" . 'App\\AdminBundle\\Entity\\Lista' . "\0" . 'Usuario', '' . "\0" . 'App\\AdminBundle\\Entity\\Lista' . "\0" . 'menus'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Lista $proxy) {
