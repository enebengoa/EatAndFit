 ...
 */
class TemaForo extends \App\AdminBundle\Entity\TemaForo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\AdminBundle\\Entity\\TemaForo' . "\0" . 'id', '' . "\0" . 'App\\AdminBundle\\Entity\\TemaForo' . "\0" . 'nombre', '' . "\0" . 'App\\AdminBundle\\Entity\\TemaForo' . "\0" . 'descripcion', '' . "\0" . 'App\\AdminBundle\\Entity\\TemaForo' . "\0" . 'fechaCreacion', '' . "\0" . 'App\\AdminBundle\\Entity\\TemaForo' . "\0" . 'Usuariooo', '' . "\0" . 'App\\AdminBundle\\Entity\\TemaForo' . "\0" . 'comentarios', '' . "\0" . 'App\\AdminBundle\\Entity\\TemaForo' . "\0" . 'puntuaciones'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TemaForo $proxy) {
    ...
    public function setUsuariooo(\App\AdminBundle\Entity\Usuario $usuariooo = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUsuariooo', [$usuariooo]);

        return parent::setUsuariooo($usuariooo);
    }
    ...
    public function getUsuariooo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUsuariooo', []);

        return parent::getUsuariooo();
    }
