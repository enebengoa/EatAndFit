 ...
 */
class HoraIngesta extends \App\AdminBundle\Entity\HoraIngesta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\AdminBundle\\Entity\\HoraIngesta' . "\0" . 'id', '' . "\0" . 'App\\AdminBundle\\Entity\\HoraIngesta' . "\0" . 'nombre', '' . "\0" . 'App\\AdminBundle\\Entity\\HoraIngesta' . "\0" . 'recetas', '' . "\0" . 'App\\AdminBundle\\Entity\\HoraIngesta' . "\0" . 'subMenus'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HoraIngesta $proxy) {
