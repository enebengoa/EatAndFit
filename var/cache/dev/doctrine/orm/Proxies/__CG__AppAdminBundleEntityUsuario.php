...
class Usuario extends \App\AdminBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'App\\AdminBundle\\Entity\\Usuario' . "\0" . 'listas', '' . "\0" . 'App\\AdminBundle\\Entity\\Usuario' . "\0" . 'menus', '' . "\0" . 'App\\AdminBundle\\Entity\\Usuario' . "\0" . 'comentarios', '' . "\0" . 'App\\AdminBundle\\Entity\\Usuario' . "\0" . 'temasforo', '' . "\0" . 'App\\AdminBundle\\Entity\\Usuario' . "\0" . 'puntuaciones', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt'];
        }
