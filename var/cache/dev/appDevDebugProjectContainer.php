...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.doctrine_brochure_listener' => 'getApp_DoctrineBrochureListenerService',
     ...
     * This method always returns the same instance of the service.
     *
     * @return \App\AdminBundle\FileUploader A App\AdminBundle\FileUploader instance
     */
    protected function getApp_BrochureUploaderService()
    {
        return $this->services['app.brochure_uploader'] = new \App\AdminBundle\FileUploader(($this->targetDirs[3].'\\app/../web/imagenes'));
    }

    /**
     * Gets the 'app.doctrine_brochure_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \App\AdminBundle\EventListener\BrochureUploadListener A App\AdminBundle\EventListener\BrochureUploadListener instance
     */
    protected function getApp_DoctrineBrochureListenerService()
    {
        return $this->services['app.doctrine_brochure_listener'] = new \App\AdminBundle\EventListener\BrochureUploadListener($this->get('app.brochure_uploader'));
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('1GmdqdHwsp', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('H01lE8HHFl', 0, 'PHXplJoBQ-Zd5UoyviusVA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wKaSrx+8Xu', 0, 'PHXplJoBQ-Zd5UoyviusVA', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('W3UQ-3ggAC', 0, 'PHXplJoBQ-Zd5UoyviusVA', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventListener(array(0 => 'prePersist', 1 => 'preUpdate'), $this->get('app.doctrine_brochure_listener'));
        $c->addEventListener(array(0 => 'loadClassMetadata'), $this->get('doctrine.orm.default_listeners.attach_entity_listeners'));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'pfg_eneko', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\App\\AdminBundle\\Entity'))), 'App\\AdminBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('AdminBundle' => 'App\\AdminBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_05cb7f6c300e6b2b4b6a43522e76e420763292b2c0a8d5b34fe930bae9d0f643');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('App\\AdminBundle\\Entity\\Usuario');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'FOSUserBundle:Registration:email.txt.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('enebengoa@hotmail.com' => 'No_Reply'), 'resetting' => array('enebengoa@hotmail.com' => 'No_Reply'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('App\\AdminBundle\\Entity\\Usuario');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('App\\AdminBundle\\Entity\\Usuario');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('App\\AdminBundle\\Entity\\Usuario');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'App\\AdminBundle\\Entity\\Usuario');
    }
    ...
    {
        $a = new \Metadata\Driver\FileLocator(array('Symfony\\Bundle\\FrameworkBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/config/serializer'), 'Symfony\\Bundle\\SecurityBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/config/serializer'), 'Symfony\\Bundle\\TwigBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/config/serializer'), 'Symfony\\Bundle\\MonologBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\monolog-bundle/Resources/config/serializer'), 'Symfony\\Bundle\\SwiftmailerBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\swiftmailer-bundle/Resources/config/serializer'), 'Doctrine\\Bundle\\DoctrineBundle' => ($this->targetDirs[3].'\\vendor\\doctrine\\doctrine-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\FrameworkExtraBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\framework-extra-bundle/Resources/config/serializer'), 'App\\AdminBundle' => ($this->targetDirs[3].'\\src\\App\\AdminBundle/Resources/config/serializer'), 'App\\UserBundle' => ($this->targetDirs[3].'\\src\\App\\UserBundle/Resources/config/serializer'), 'FOS\\UserBundle' => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/config/serializer'), 'blackknight467\\StarRatingBundle' => ($this->targetDirs[3].'\\vendor\\blackknight467\\star-rating-bundle\\blackknight467\\StarRatingBundle/Resources/config/serializer'), 'Knp\\Bundle\\PaginatorBundle' => ($this->targetDirs[3].'\\vendor\\knplabs\\knp-paginator-bundle/Resources/config/serializer'), 'FOS\\JsRoutingBundle' => ($this->targetDirs[3].'\\vendor\\friendsofsymfony\\jsrouting-bundle/Resources/config/serializer'), 'JMS\\SerializerBundle' => ($this->targetDirs[3].'\\vendor\\jms\\serializer-bundle\\JMS\\SerializerBundle/Resources/config/serializer'), 'Symfony\\Bundle\\DebugBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\DebugBundle/Resources/config/serializer'), 'Symfony\\Bundle\\WebProfilerBundle' => ($this->targetDirs[3].'\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/config/serializer'), 'Sensio\\Bundle\\DistributionBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\distribution-bundle/Resources/config/serializer'), 'Sensio\\Bundle\\GeneratorBundle' => ($this->targetDirs[3].'\\vendor\\sensio\\generator-bundle/Resources/config/serializer')));
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('euskaldunbaserria@gmail.com');
        $a->setPassword('Baserria2015');
        $a->setAuthMode('login');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\FormExtension(new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'StarRatingBundle::rating.html.twig', 1 => 'form_div_layout.html.twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE))));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\App\\AdminBundle/Resources/views'), 'Admin');
        $instance->addPath(($this->targetDirs[3].'\\src\\App\\UserBundle/Resources/views'), 'User');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('86c05b22c5ea395b251c4ef020291497afd7960a');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'UserBundle' => 'App\\UserBundle\\UserBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'pfg_eneko',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'gmail',
            'mailer_host' => 'smtp.gmail.com',
            'mailer_user' => 'euskaldunbaserria@gmail.com',
            'mailer_password' => 'Baserria2015',
            'secret' => '86c05b22c5ea395b251c4ef020291497afd7960a',
            'locale' => 'en',
            'brochures_directory' => ($this->targetDirs[3].'\\app/../web/imagenes'),
            'newsletters_directory' => ($this->targetDirs[3].'\\app/../web/newsletters'),
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '86c05b22c5ea395b251c4ef020291497afd7960a',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'euskaldunbaserria@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'Baserria2015',
            ...
            'fos_user.model.user.class' => 'App\\AdminBundle\\Entity\\Usuario',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'enebengoa@hotmail.com' => 'No_Reply',
            ),
